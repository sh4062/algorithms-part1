...
public class BruteCollinearPoints {
	...
	public String toString() {
		return "BruteCollinearPoints [numberOfSegments=" + numberOfSegments + ", numberOfPoints=" + numberOfPoints
				+ ", points=" + Arrays.toString(points) + ", segments=" + Arrays.toString(segments) + "]";
	}
